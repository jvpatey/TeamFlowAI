...
export function FlowingBackground({ className = "" }: FlowingBackgroundProps) {
  return (
    <div className={`absolute inset-0 overflow-hidden ${className}`}>
      {/* Main flowing shape */}
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-keppel/20 via-purple-500/15 to-blue-500/20 dark:from-keppel/40 dark:via-purple-500/35 dark:to-blue-500/40 rounded-full blur-3xl animate-pulse"></div>
      <div
        className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-blue-500/20 via-keppel/15 to-purple-500/20 dark:from-blue-500/40 dark:via-keppel/35 dark:to-purple-500/40 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>

      {/* Additional bold shapes */}
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-keppel/15 via-transparent to-purple-500/15 dark:from-keppel/25 dark:via-transparent dark:to-purple-500/25 rounded-full blur-2xl animate-pulse"
        style={{ animationDuration: "4s" }}
      ></div>

      {/* Flowing organic shapes */}
      <div
        className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-br from-keppel/20 to-blue-500/15 dark:from-keppel/30 dark:to-blue-500/20 rounded-full blur-2xl animate-bounce"
        style={{ animationDuration: "8s" }}
      ></div>
      <div
        className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-gradient-to-tl from-purple-500/25 to-keppel/15 dark:from-purple-500/35 dark:to-keppel/25 rounded-full blur-2xl animate-bounce"
        style={{ animationDuration: "6s", animationDelay: "2s" }}
      ></div>

      {/* Stronger mid-layer shapes */}
      <div
        className="absolute top-1/3 right-1/3 w-32 h-32 bg-gradient-to-bl from-blue-500/25 to-transparent dark:from-blue-500/40 dark:to-transparent rounded-full blur-xl animate-pulse"
